...
public class CustomTool : QuillTool
{
	...
	public Func<CustomTool, MudExRichTextEdit, string> Text { get; set; }
	...
	public CustomTool(
		Func<CustomTool, MudExRichTextEdit, Task> onClick,
		string icon,
		string tooltip = "",
		Color color = MudBlazor.Color.Inherit,
		int group = 99,
		string cls = "",
		string text = null) : base(cls, "", group)
	{
		OnClick = onClick;
		Icon = (_, _) => icon;
		Text = (_, _) => text;
	...
	public CustomTool(
		Func<CustomTool, MudExRichTextEdit, Task> onClick,
		Func<CustomTool, MudExRichTextEdit, string> icon,
		Func<CustomTool, MudExRichTextEdit, string> tooltip = null,
		Func<CustomTool, MudExRichTextEdit, Color> color = null,
		int group = 99,
		string cls = "",
		Func<CustomTool, MudExRichTextEdit, string> text = null) : base(cls, "", group)
	{
		OnClick = onClick;
		Icon = icon;
		Text = text ?? ((_, _) => string.Empty);
